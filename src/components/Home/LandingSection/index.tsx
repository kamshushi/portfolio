...
export default function LandingSection() {
  return (
    <SectionContainer>
      <div className="h-svh">
        <div className="pt-32 flex gap-32 justify-center sm:flex-wrap xl:flex-nowrap">
          ...
          <div>
            <div className="font-main">
              ...
              <p className="mt-5">
                ...
                the school. I enjoy playing guitar and video games in my free
                time. I will also respond to any technical issues and new
